...
The Terraform configuration in this directory creates the Google Cloud Platform infrastructure needed to deploy and compare the performance of Go vs Node.js applications using Cloud Run, Firestore, and observability tools.
